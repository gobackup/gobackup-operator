...
//+kubebuilder:rbac:groups=gobackup.io,resources=backupmodels,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=gobackup.io,resources=backupmodels/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=gobackup.io,resources=backupmodels/finalizers,verbs=update
