...
type InfluxDBSpec struct {
	...
	SkipVerify string `json:"skipVerify,omitempty" yaml:"skipVerify,omitempty"`
	HttpDebug  string `json:"httpDebug,omitempty" yaml:"httpDebug,omitempty"`
}

// InfluxDBSpecConfig duplicates InfluxDBSpec for gobackup config file
type InfluxDBSpecConfig struct {
	Host       string `json:"host,omitempty" yaml:"host,omitempty"`
	Token      string `json:"token,omitempty" yaml:"token,omitempty"`
	Bucket     string `json:"bucket,omitempty" yaml:"bucket,omitempty"`
	BucketID   string `json:"bucketID,omitempty" yaml:"bucketID,omitempty"`
